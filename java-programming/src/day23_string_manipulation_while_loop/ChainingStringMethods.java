...
public class ChainingStringMethods {
    public static void main(String[] args) {
        ...
        String town = "Baku";
        System.out.println(town.substring(0,1).toUpperCase().toLowerCase()+town.substring(1).replace("u","a").equals("baka"));
        System.out.println(town.equals("baka"));
        System.out.println(town);

        // city.isEmpty().toUpperCase() doesn't work because isEmpty is boolean
